...
{{--                    $likes = \App\LikeDislikePlace::select('like')->where('place_id',1)->get();--}}
{{--                    $like = $likes[0]->like;--}}
{{--                @endphp--}}
...
{{--                    $dislikes = \App\LikeDislikePlace::select('dislike')->where('place_id',1)->get();--}}
{{--                    $dislike = $dislikes[0]->dislike;--}}
{{--                @endphp--}}
                <span>{{$dislikes}}</span>

...
@section('content')
    ...
    @if (session('status'))
        <div class="alert alert-success">
            <h3 style="color: #9561e2">{{ session('status') }}</h3>
        </div>
    @endif
